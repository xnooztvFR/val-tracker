...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::save_overlay_secondary_monitor,
            commands::save_overlay_postgame_summary_enabled,
            commands::save_overlay_postgame_summary_autodismiss_secs,
            commands::save_friend_live_notify_enabled,
